...
- one explicit `RapierWorldBehaviour`
...
The sample uses `RapierWorldBehaviour` stepping in `FixedUpdate`, syncs the dynamic body's transform back to Unity, and logs a state hash once per simulated second.
